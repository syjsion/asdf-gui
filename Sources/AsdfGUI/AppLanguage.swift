...
enum AppLanguage: String, CaseIterable, Identifiable, Sendable {
    ...
    private static let fallbackChinese: [String: String] = [
        ...
        "Favorites": "收藏",
        "Favorite": "收藏",
        "Favorite project": "收藏项目",
        "Recently used": "最近使用",
        "Last used": "最后使用",
        "Add to Favorites": "加入收藏",
        "Remove from Favorites": "取消收藏",
        "No favorite projects": "暂无收藏项目",
        "Mark frequently used projects as favorites to keep them at the top and filter to them quickly.": "将常用项目加入收藏，可固定在列表前部并快速筛选。",
        ...
        "Measure installed runtime folders and clean up only through asdf uninstall.": "统计已安装运行时目录的磁盘占用，并且只通过 asdf uninstall 执行清理。",
        "Measure disk usage for installed versions of the selected plugin.": "统计所选插件各已安装版本的磁盘占用。",
        "Sort storage": "存储排序",
        "Largest first": "占用最大优先",
        "Rescan": "重新扫描",
        "Storage Summary": "存储摘要",
        "Measured size": "已统计大小",
        "Installed versions": "已安装版本",
        "Measurement errors": "统计错误",
        "No installed versions": "没有已安装版本",
        "This plugin has no installed runtime versions to measure.": "该插件没有可统计的已安装运行时版本。",
        "Measuring runtime folders…": "正在统计运行时目录…",
        "Version": "版本",
        "Disk Usage": "磁盘占用",
        "Install Path": "安装路径",
        "Reveal runtime in Finder": "在 Finder 中显示运行时",
        "Sizes are measured on demand from paths reported by asdf where. asdf GUI never deletes runtime folders directly.": "大小按需根据 asdf where 返回的路径统计；asdf GUI 永远不会直接删除运行时目录。",
        "Unknown size": "大小未知",
        ...
        "asdf Configuration": "asdf 配置",
        "asdf Configuration…": "asdf 配置…",
        "Manage machine-specific .asdfrc settings without editing the file as raw text.": "以结构化方式管理机器级 .asdfrc 设置，无需直接编辑原始文件。",
        "Configuration file": "配置文件",
        "Path comes from ASDF_CONFIG_FILE.": "配置路径来自 ASDF_CONFIG_FILE。",
        "ASDF_CONCURRENCY is set to %@ and overrides the value below.": "ASDF_CONCURRENCY 当前为 %@，会覆盖下方并发设置。",
        "Version resolution": "版本解析",
        "Use legacy version files when supported": "在插件支持时读取旧版版本文件",
        "Allow release candidates": "允许候选发布版本",
        "Downloads": "下载",
        "Keep downloaded source or binaries after install": "安装成功后保留下载的源码或二进制",
        "Plugin short-name repository": "插件短名称仓库",
        "Disable short-name repository": "禁用短名称仓库",
        "Repository sync": "仓库同步",
        "Every trigger": "每次触发",
        "Every N minutes": "每 N 分钟",
        "Never": "从不",
        "Minutes": "分钟",
        "Plugin discovery by short name may be unavailable while this repository is disabled. Explicit Git URL installs still work.": "禁用该仓库后，按短名称发现插件可能不可用；显式 Git URL 安装仍可使用。",
        ...
        "asdf configuration saved.": "asdf 配置已保存。",
        "Apply health fix?": "应用健康修复？",
        "Apply Fix": "应用修复",
        "Install Plugin": "安装插件",
        "Install Runtime": "安装运行时",
        "Health Fix Task": "健康修复任务",
